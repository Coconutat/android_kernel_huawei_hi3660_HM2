...
#else
#define OAL_GET_CORE_ID()    (0)        /* ҪE5ƽ̨ʹ */
#endif
#endif
...
#define  OAL_PLAT_MEM_BASE_ADDR  0x15E00000   /* DDRʼַ0xA0000000 - V200оƬַƫ0x40000000 */
#elif defined _PRE_CPE_722_PLATFORM
#define  OAL_PLAT_MEM_BASE_ADDR  0x60000000   /* DDRʼַ0x55E00000 - V200оƬַƫ0x40000000 */
#endif
...
{
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 10, 44))
    usleep_range(min_us, max_us);/*΢˯ߣóCPU*/
#else
