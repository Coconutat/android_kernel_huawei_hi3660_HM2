...
oal_int32 oal_pcie_read_dsm32(oal_pcie_res* pst_pci_res, PCIE_SHARED_DEVICE_ADDR_TYPE type, oal_uint32 *val)
{
    ...
    {
        /*cache 无效化*/
        oal_pci_cache_inv(pst_pci_dev, (oal_void*)pst_pci_res->st_device_shared_addr_map[type].pa, sizeof(oal_uint32 *));
    }
#endif
                                           ...
                                           oal_uint32 test_time)
{
    ...
    total_size = (oal_uint64)((HCC_HDR_TOTAL_LEN + PCIE_EDMA_TRANS_MAX_FRAME_LEN)* count);
